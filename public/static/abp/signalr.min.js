    ...
    var Transports = createCommonjsModule(function (module, exports) {
            ...
            ServerSentEventsTransport.prototype.send = function (data) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2, send(this.logger, "SSE", this.httpClient, this.url, this.accessTokenFactory, data)]
                    })
                })
            };
        ...
        var LongPollingTransport = function () {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        case 0:
                            ...
                            _a.label = 1;
                        case 1:
                            if (!!this.pollAbort.signal.aborted) return [3, 6];
                            _a.label = 2;
                        case 2:
                            _a.trys.push([2, 4, , 5]);
            ...
            LongPollingTransport.prototype.send = function (data) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2, send(this.logger, "LongPolling", this.httpClient, this.url, this.accessTokenFactory, data)]
                    })
                })
            };
            ...
            HttpConnection.prototype.startInternal = function (transferFormat) {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        ...
                        case 0:
                            _b.trys.push([0, 6, , 7]);
                            if (!(this.options.transport === Transports.TransportType.WebSockets)) return [3, 2];
                            this.url = this.baseUrl;
                            this.transport = this.constructTransport(Transports.TransportType.WebSockets);
                            return [4, this.transport.connect(this.url, transferFormat, this)];
                        case 1:
                            _b.sent();
                            return [3, 5];
                        case 2:
                            ...
                            return [4, this.getNegotiationResponse(headers)];
                        case 3:
                            negotiateResponse = _b.sent();
                            if (this.connectionState === 2) {
                                return [2]
                            }
                            return [4, this.createTransport(this.options.transport, negotiateResponse, transferFormat, headers)];
                        case 4:
                            _b.sent();
                            _b.label = 5;
                        case 5:
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        case 0:
                            ...
                            return [4, this.transport.connect(this.url, requestedTransferFormat, this)];
                        case 1:
                            _a.sent();
                            this.changeState(0, 1);
                            return [2];
            ...
            HttpConnection.prototype.resolveTransport = function (endpoint, requestedTransport, requestedTransferFormat) {
                ...
                if (transport === null || transport === undefined) {
                    ...
                    var transferFormats = endpoint.transferFormats.map(function (s) {
                        return Transports.TransferFormat[s]
                    });
                    if (!requestedTransport || transport === requestedTransport) {
                        if (transferFormats.indexOf(requestedTransferFormat) >= 0) {
                            if (transport === Transports.TransportType.WebSockets && typeof WebSocket === "undefined" || transport === Transports.TransportType.ServerSentEvents && typeof EventSource === "undefined") {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        case 3:
                            ...
                            return [3, 4];
                        case 4:
                            this.stopConnection(previousState === 1, error);
                            return [2]
                        }
                    })
                })
                ...
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        ...
                        case 1:
                            ...
                            return [4, this.connection.send(TextMessageFormat_1.TextMessageFormat.write(JSON.stringify({
