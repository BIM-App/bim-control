<template>
  <div class="table-box">
    <el-table :data="tableData"
      ...
      <el-table-column align="right">
        <template slot="header" slot-scope="">
          <div class="right-bar">
            <el-button size="medium" class="addTask" type="primary" icon="el-icon-plus" @click="taskDialogVisible = true">添加任务</el-button>
            <!-- <el-input
              v-model="search"
              disabled
              size="medium"
        ...
        <template slot-scope="scope">
          <el-button size="medium" @click="handleEdit(scope.$index, scope.row);
                    open()">编辑</el-button>
          <el-button size="medium" type="danger" @click="delTaskByTid(scope.$index, scope.row);
    ...
    <!-- 添加任务信息 -->
    <el-dialog title="添加任务信息" :visible.sync="taskDialogVisible" style="margin-top:-40px">
      <el-row :gutter="15">
        <el-form ref="taskForm" :model="taskForm" label-width="100px">
          ...
          <el-col :span="24">
            <el-form-item label="任务照片" prop="photoFileURL" required>
              <el-upload action="" :on-change="handleChange" :http-request="addTaskForm" ref="upload" :auto-upload="false"
      ...
      addTaskForm() {
        ...
        addTask(data).then((res) => {
          ...
          if (res.data.code === 200) {
            findTaskByPid(getProjectPID()).then((e) => {
